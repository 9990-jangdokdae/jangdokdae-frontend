...
export const issues: Issue[] = [
  {
    id: "openai-memory-rebound",
    title: "저력의 삼성전자, 오픈AI 악재에도 장중 반등",
    collectedAt: "2026-05-02T13:05:30.767Z",
    source: { name: "줍줍 리포트", publishedAt: "2026.04.29" },
    sectors: ["AI", "반도체"],
    companies: ["삼성전자", "SK하이닉스"],
    keywords: ["OpenAI", "메모리", "투자 심리", "AI 추론"],
    translation: {
      title: "저력의 삼성전자, 오픈AI 악재에도 장중 반등",
      explanation: [
    ...
    quizzes: [
      ...
      {
        id: "openai-memory-rebound-issue",
        kind: "issue",
  ...
  {
    id: "battery-safety-check",
    title: "전기차 화재 우려에 배터리 안전 진단 기업 주목",
    collectedAt: "2026-05-02T10:30:00.000Z",
    source: { name: "장독대 데모 데이터", publishedAt: "2026.05.02" },
    sectors: ["2차전지"],
    companies: ["LG에너지솔루션", "현대차"],
    keywords: ["배터리", "전기차", "안전 진단", "리콜"],
    translation: {
      title: "전기차 화재 우려에 배터리 안전 진단 기업 주목",
      explanation: [
  ...
  },
  {
    ...
    collectedAt: "2026-05-01T16:40:00.000Z",
    source: { name: "장독대 데모 데이터", publishedAt: "2026.05.01" },
    sectors: ["금융"],
    companies: ["KB금융"],
    keywords: ["금리", "은행", "순이자마진", "대출"],
    translation: {
      title: "금리 방향성 논쟁 속 은행주의 이자이익 전망 엇갈려",
      explanation: [
  ...
  {
    id: "defense-export-order",
    title: "방산 수출 기대감에 항공우주 부품주 관심 확대",
    collectedAt: "2026-05-01T09:20:00.000Z",
    source: { name: "장독대 데모 데이터", publishedAt: "2026.05.01" },
    sectors: ["방산"],
    companies: ["한화에어로스페이스"],
    keywords: ["방산", "수출", "항공우주", "수주"],
    translation: {
      title: "방산 수출 기대감에 항공우주 부품주 관심 확대",
      explanation: [
